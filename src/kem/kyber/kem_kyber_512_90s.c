...
#if defined(OQS_USE_AES_INSTRUCTIONS)  && defined(OQS_USE_AVX2_INSTRUCTIONS)  && defined(OQS_USE_BMI2_INSTRUCTIONS)  && defined(OQS_USE_POPCNT_INSTRUCTIONS)  && defined(OQS_ENABLE_KEM_kyber_512_90s_avx2)

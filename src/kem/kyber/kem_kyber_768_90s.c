...
int PQCLEAN_KYBER76890S_CLEAN_crypto_kem_enc(unsigned char *ct, unsigned char *ss, const unsigned char *pk);
int PQCLEAN_KYBER76890S_CLEAN_crypto_kem_dec(unsigned char *ss, const unsigned char *ct, const unsigned char *sk);
...
#if defined(OQS_USE_AES_INSTRUCTIONS)  && defined(OQS_USE_AVX2_INSTRUCTIONS)  && defined(OQS_USE_BMI2_INSTRUCTIONS)  && defined(OQS_USE_POPCNT_INSTRUCTIONS)  && defined(OQS_ENABLE_KEM_kyber_768_90s_avx2)

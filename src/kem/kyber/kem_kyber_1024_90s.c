...
int PQCLEAN_KYBER102490S_CLEAN_crypto_kem_enc(unsigned char *ct, unsigned char *ss, const unsigned char *pk);
int PQCLEAN_KYBER102490S_CLEAN_crypto_kem_dec(unsigned char *ss, const unsigned char *ct, const unsigned char *sk);
...
#if defined(OQS_USE_AES_INSTRUCTIONS)  && defined(OQS_USE_AVX2_INSTRUCTIONS)  && defined(OQS_USE_BMI2_INSTRUCTIONS)  && defined(OQS_USE_POPCNT_INSTRUCTIONS)  && defined(OQS_ENABLE_KEM_kyber_1024_90s_avx2)
#ifdef OQS_ENABLE_CPUFEATURES
	if (OQS_RT_cpu_flags().AES_INSTRUCTIONS  && OQS_RT_cpu_flags().AVX2_INSTRUCTIONS  && OQS_RT_cpu_flags().BMI2_INSTRUCTIONS  && OQS_RT_cpu_flags().POPCNT_INSTRUCTIONS ) {

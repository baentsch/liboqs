...
int OQS_RT_AVX_INSTRUCTIONS = 0 ;
int OQS_RT_AVX2_INSTRUCTIONS = 0 ;
int OQS_RT_AVX512_INSTRUCTIONS = 0 ;
int OQS_RT_BMI_INSTRUCTIONS = 0 ;
int OQS_RT_BMI2_INSTRUCTIONS = 0 ;
int OQS_RT_FMA_INSTRUCTIONS = 0 ;
int OQS_RT_FMA4_INSTRUCTIONS = 0 ;
int OQS_RT_MMX_INSTRUCTIONS = 0 ;
int OQS_RT_POPCNT_INSTRUCTIONS = 0 ;
int OQS_RT_SSE_INSTRUCTIONS = 0 ;
int OQS_RT_SSE2_INSTRUCTIONS = 0 ;
int OQS_RT_SSE3_INSTRUCTIONS = 0 ;
int OQS_RT_SSE4A_INSTRUCTIONS = 0 ;
int OQS_RT_NEON_INSTRUCTIONS = 0;
int OQS_RT_AES_INSTRUCTIONS = 0 ;

...
#if defined(OQS_USE_AVX2_INSTRUCTIONS)  && defined(OQS_USE_BMI2_INSTRUCTIONS)  && defined(OQS_ENABLE_SIG_dilithium_3_avx2)
...
#if defined(OQS_USE_AVX2_INSTRUCTIONS)  && defined(OQS_USE_BMI2_INSTRUCTIONS)  && defined(OQS_ENABLE_KEM_dilithium_3_avx2)
#ifdef OQS_ENABLE_CPUFEATURES
	if (OQS_RT_cpu_flags().AVX2_INSTRUCTIONS  && OQS_RT_cpu_flags().BMI2_INSTRUCTIONS ) {
